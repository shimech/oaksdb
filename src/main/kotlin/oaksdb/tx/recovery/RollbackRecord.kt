...
data class RollbackRecord private constructor(
    ...
    companion object {
        ...
        fun of(page: Page): RollbackRecord {
            ...
            return RollbackRecord(txNumber)
        }
